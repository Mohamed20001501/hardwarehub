    ...
    <div className="max-w-md mx-auto px-4 py-16 sm:py-20 animate-fade-in">
      <div className="bg-white border border-slate-100 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6 relative overflow-hidden">
        ...
        <div className="text-center space-y-1.5">
          ...
          <p className="text-slate-400 text-xs font-semibold uppercase tracking-wider">Register for Ceylon's Hardware Market</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Password input */}
          <div className="space-y-1">
            <label className="block text-xs font-bold text-slate-500 uppercase">Create Password</label>
            <div className="relative">
              <input
                type="password"
                required
          ...
          <div className="space-y-1">
            <label className="block text-xs font-bold text-slate-500 uppercase">I want to register as a...</label>
            <div className="relative">
              <select
                value={form.role}
                onChange={(e) => setForm({ ...form, role: e.target.value })}
                className="w-full bg-slate-50 border border-slate-200 focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 text-sm px-3.5 py-2.5 rounded-xl outline-none transition-all font-semibold"
              >
                <option value="customer">Buyer / Customer (Browse & Order)</option>
                <option value="vendor">Merchant / Vendor (Sell & Manage)</option>
              </select>
            </div>
          </div>
